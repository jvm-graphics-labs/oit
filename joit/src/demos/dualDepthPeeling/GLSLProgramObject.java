...
public class GLSLProgramObject {
    ...
    public void attachVertexShader(GL2 gl, String filename, String path) {
...
//				File.separator + "shaders" + File.separator + filename);
        URL fileURL = getClass().getClassLoader().getResource(path + filename);
        if (fileURL != null) {
            String content = "";
    ...
    public void attachFragmentShader(GL2 gl, String filename, String path) {
//		URL fileURL = getClass().getClassLoader().getResource(
//				File.separator + "demos" +
//				File.separator + "dualDepthPeeling" +
//				File.separator + "shaders" + File.separator + filename);
