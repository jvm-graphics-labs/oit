...
public class WeightedBlendedOpaque {
    ...
    public static float weightParameter = 0.5f;
    ...
    private void initRenderTargets(GL4 gl4) {
        ...
        gl4.glTextureStorage2D(textureName.get(Texture.SUM_COLOR), 1, GL_RGBA16F, size.x, size.y);
        ...
        gl4.glTextureStorage2D(textureName.get(Texture.SUM_WEIGHT), 1, GL_R8, size.x, size.y);
        ...
        gl4.glTextureStorage2D(textureName.get(Texture.OPAQUE_DEPTH), 1, GL_DEPTH_COMPONENT32F, size.x, size.y);
        ...
        gl4.glTextureStorage2D(textureName.get(Texture.OPAQUE_COLOR), 1, GL_RGBA8, size.x, size.y);
