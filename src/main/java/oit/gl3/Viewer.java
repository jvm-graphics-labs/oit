...
public class Viewer implements GLEventListener {
    ...
    private void initBuffers(GL3 gl3) {
        ...
        glm.ortho(0, 1, 0, 1).to(modelToClip);
    ...
    public void display(GLAutoDrawable glad) {
        ...
        {
            Vec3 eye = InputListener.pos;
            Vec3 center = new Vec3((float)InputListener.pos.x, (float)InputListener.pos.y, 0f);
            Vec3 up = new Vec3(0, 1, 0);
            glm.lookAt(view, eye, center, up)
                    ...
                    .scale(Model.scale);
            proj.times(view, projView).to(Resources.matBuffer);
...
//        gl3.glColorMask(true, true, true, true);
    ...
    public void reshape(GLAutoDrawable glad, int x, int y, int width, int height) {
        ...
        {
            glm.perspective(proj, (float) Math.toRadians(30f), (float) width / height, 0.0001f, 10);
            proj.to(Resources.matBuffer);
        }
