...
import depthPeeling.dpGl3OfficialOpaque.glsl.Blend;
import depthPeeling.dpGl3OfficialOpaque.glsl.Final;
import depthPeeling.dpGl3OfficialOpaque.glsl.Init;
import depthPeeling.dpGl3OfficialOpaque.glsl.Peel;
import depthPeeling.dpGl3OfficialOpaque.glsl.Opaque;
...
//        System.out.println("numGeoPasses " + numGeoPasses);
    ...
    private void buildShaders(GL3 gl3, int blockBinding) {
        ...
        String shadersFilepath = "/depthPeeling/dpGl3OfficialOpaque/glsl/shaders/";
        ...
        dpOpaque = new Opaque(gl3, shadersFilepath, "dpOpaque_VS.glsl", "dpOpaque_FS.glsl", blockBinding);
