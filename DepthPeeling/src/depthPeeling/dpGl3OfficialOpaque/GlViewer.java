...
public class GlViewer implements GLEventListener {
    ...
    public void init(GLAutoDrawable glad) {
        ...
        try {
            scene = new Scene(gl3, "/depthPeeling/data/dragon.obj");
...
//        System.out.println("getFPSStartTime "+animator.getFPSStartTime());
//        System.out.println("getLastFPS "+animator.getLastFPS());
//        System.out.println("getLastFPSPeriod "+animator.getLastFPSPeriod());
//        System.out.println("getLastFPSUpdateTime "+animator.getLastFPSUpdateTime());
//        System.out.println("getTotalFPS "+animator.getTotalFPS());
//        System.out.println("getTotalFPSDuration "+animator.getTotalFPSDuration());
//        System.out.println("getTotalFPSFrames "+animator.getTotalFPSFrames());
//        System.out.println("getUpdateFPSFrames "+animator.getUpdateFPSFrames());
    }
